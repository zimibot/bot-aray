...
fs.readFile('./sessionye/haikal.json', function (err, data) {
  if (data) {
    var json = JSON.parse(data)
  
    json.keys.sessions = {}
    json.keys.preKeys = {}
    json.keys.senderKeys = {}
    json.keys.appStateSyncKeys = {}
    json.keys.appStateVersions = {}
    json.keys.senderKeyMemory = {}
  
    setInterval(() => {
      fs.writeFileSync('./sessionye/haikal.json', JSON.stringify(json, null, 2));
    }, 1000);
  }
